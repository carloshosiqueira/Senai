export default [
...

    {
        ...
        answers: [
            ...
            {option: "Expulsão do jogador", correct:false},
        ],
    },
    ...
    {
        question: "Por que o libero usa uma camisa diferente do resto do time?",
        answers: [
    ...
    {
        question: "Qual é o nome da infração quando o jogador usa algum objeto perto da quadra para alcançar a bola?",
        answers: [
            {option: "Toque apoiado", correct:true},
            {option: "Invasão", correct:false},
            {option: "2 toques", correct:false},
        ],
        
    },
    {
        question: "Um jogador ao realizar o bloqueio, pode tocar na bola em sequência",
        answers: [
            {option: "Sim, pois o bloqueio não conta como toque", correct:true},
            {option: "Não, pois mesmo que o bloqueio não conte como toque, ele não pode tocar na bola 2 vezes seguidas", correct:false},
        ],
        
    },
    {
        question: "Um jogador que está na parte do fundo da quadra pisa na linha de 3m na hora do ataque o que o juiz deve marcar?:",
        answers: [
    ...
    {
        question: "O saque deve ser realizado entre as linhas laterais da quadra",
        answers: [
            {option: "Verdadeiro", correct:true},
            {option: "Falso", correct:false},
        ],
    ...
    {
        question: "O que acontece quando o saque bate na rede, porém passa para o outro lado da quadra?",
        answers: [
