...
function jogar(num) {
    ...
    switch (num) {
        ...
        case tesoura:
            ...
            break;
        case lizard:
            test.innerHTML = lizard.outerHTML
            test.value = lizard.value
            break;
        case spock:
...
function Resolucao() {
    if ((test.value === "pedra" && test1.value === "tesoura") ||
        (test.value === "pedra" && test1.value === "lizard") ||
        (test.value === "tesoura" && test1.value === "papel") ||
        (test.value === "tesoura" && test1.value === "lizard") ||
        ...
        (test.value === "lizard" && test1.value === "spock") ||
        (test.value === "lizard" && test1.value === "papel")) {
            ...
            console.log(test.value, test1.value);
               ...
               (test.value === "papel" && test1.value === "lizard") ||
               (test.value === "spock" && test1.value === "lizard") ||
               (test.value === "tesoura" && test1.value === "pedra") ||
               (test.value === "lizard" && test1.value === "pedra") ||
               (test.value === "lizard" && test1.value === "tesoura") ||
