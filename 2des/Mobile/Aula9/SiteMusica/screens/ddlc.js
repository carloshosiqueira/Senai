...
export default class Ddlc extends Component {
  constructor(props) {
    super(props);
    this.state = {
      sounds: [],
  ...
  async componentDidMount() {
    ...
    this.loadSound(require('../assets/music/ddlc/DearSunshine.mp3'), 'Dear Sunshine');
    this.loadSound(require('../assets/music/ddlc/LavenderMist.mp3'), 'Lavender Mist');
    this.loadSound(require('../assets/music/ddlc/MySong_YourNote.mp3'), 'My Song, Your Note');
    this.loadSound(require('../assets/music/ddlc/PeachyPie.mp3'), 'Peachy Pie');
    this.loadSound(require('../assets/music/ddlc/PieceByPiece.mp3'), 'Piece By Piece');
  }
