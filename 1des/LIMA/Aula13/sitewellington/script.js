...
function aplicar(){
    var tipo = document.getElement('tipo').value;
    var produto = document.getElement('produto').value;
    var preco = document.getElement('preco').value;
    ...
    produto.innerHTML = this.produto
